...
In contrast, this **AI-assisted project** acts as a Proof of Concept for a modern, conversational interface. It leverages **Google Gemma 3:12b** to understand natural language queries (e.g., "What was the rate on 2024-01-15?"), prioritizing an intuitive and user-friendly experience while using the same underlying data source.
...
- **AI-Powered**: Uses Google Gemma 3:12b via Ollama with LangChain framework
...
- **Google Gemma 3:12b** model pulled in Ollama (`ollama pull gemma3:12b`)
- LangChain packages (installed via requirements.txt)
